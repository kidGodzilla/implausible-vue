...
const languageLookup = s => {
  console.log('languageLookup input', s);
  ...
  console.log('languageLookup result', s);
  return s;
}
          ...
          <div class="card-body">
            ...
            <div class="tab-content mt-5">
              ...
              <div class="tab-pane fade show" id="loadtimes">
                ...
                <PseudoTable column="pathname" valueColumn="AvgLoadTime" :loadTimes="true" :valueFormatter="twoPlacesMinZero" />
              </div>
            </div>
          </div>
        </div>
